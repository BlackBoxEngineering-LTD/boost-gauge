/*
  ESP32 Compact Digital Boost Gauge
  - Optimized performance with pre-calculated graphics
  - Non-blocking main loop with adaptive update rates
  - Sensor error detection and auto-zero calibration
  - Flicker-free sprite rendering
*/
...
bool SIMULATE = true; // Set to false for real sensor.
...
const float BAR_MAX = 1.1f; // ~16 PSI max
